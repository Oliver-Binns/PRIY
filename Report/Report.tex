...
Finally, I also propose \gls{mde} as a potential short-term solution to the computer science skills shortage, exploring some of the current \gls{mde} technologies for creating simulations and proposing further advancements to these tools for the future.
...
For example, 3D environments have had to be mapped into 2-dimensions,
%number of cell types have been reduced
%migration modelled less accurately (doesn't occur from ends of gut)
while these additional abstractions may not invalidate the model..?
...
%CSP -> OccamPi/Java MASON -> Kieran is currently looking into this
%Similar to the work described later in this report..
