...
Agent-based modelling has been previously used to implement this type of simulation, showing how the behaviour of individuals can contribute to the system as a whole.
...
In this project, 
the FLAME GPU framework will be used to help mitigate some of the difficulties with implementing parallel programs in order to build on an existing sequential Java MASON simulation.
I will also propose model-driven engineering (MDE) as a potential short-term solution to the skills shortage, exploring some of the current MDE technologies for creating simulations and proposing further advancements to these tools for the future.
}
