...
\begin{subfigure}{\textwidth}
\centering
\frame{\includegraphics[width=\textwidth]{Appendix/Sim/Start}}
...
\begin{subfigure}{\textwidth}
\centering
\frame{\includegraphics[width=\textwidth]{Appendix/Sim/Migration}}
...
\begin{subfigure}{\textwidth}
\centering
\frame{\includegraphics[width=\textwidth]{Appendix/Sim/Patch}}
...
Another \gls{FLAME GPU} addition would be the ability to add \gls{gpu}-based step functions, that can be applied to an agent, regardless of its current state.
This would make key biological features, such as environmental growth far simpler to implement.
