...
This project aims to help reduce the number of trade-offs needed when designing platform models for simulations.
...
Managing parallel implementations of algorithms has significant overheads due to the need to transfer data between parallel tasks.
